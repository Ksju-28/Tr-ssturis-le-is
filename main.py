#Uzrakstīt programmu, kas pieprasa no lietotāja ievadīt trīs leņķus(kas varētu piederēt vienam trīsstūrim) un ar funkcijas palīdzību pārbauda, vai šie leņķi ir derīgi trīsstūra veidošanai.
